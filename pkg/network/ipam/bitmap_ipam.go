...
func (ipam *BitmapIPAM) Allocate(podname string, id string, ifName string, netns string) (*ContainerNetInfo, error) {

	capacity, err := ipam.Capacity()
	if err != nil {
		return nil, err
	}
	if capacity <= 0 {
